            ...
            <div class="card">
                <div class="card-body">
                    {{-- <h4 class="header-title">Chamados</h4> --}}
                        ...
                        <div class="mb-3">
                            <input type="text" wire:model="name" class="form-control" placeholder="Nome da categoria" maxlength="255">
